...
train_folder = "../../butterfly92-2/train"
test_folder = "../../butterfly92-2/test"
load_model_path = f"../../butterfly92-2/model/1225_concate_CNN_model_{suffix}.pth" # model trained use pattern counts, replace it using your own model path
...
with open(f'./saved_shap_values/butt92-2_target1_{suffix}.pkl', 'wb') as f:
...
# Save to a file
with open(f'./saved_shap_values/butt92-2_target2_{suffix}.pkl', 'wb') as f:
    pickle.dump(shap_values, f)
